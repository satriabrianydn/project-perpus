<aside class="left-sidebar">
    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-between mt-3">
            <a href="#" class="text-nowrap logo-img mb-4">
                <img src="{{ asset('assets/img/logo/boyolali.png') }}" width="60" alt="" />
            </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            ...
            <span class="hide-menu">Home</span>
                ...
                @if (auth()->user()->role == 'Administrator')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('admin.edit') }}" aria-expanded="false">
                            <span>
